...
def main():
    ...
    print(device,args.cuda,torch.cuda.is_available())
    ...
    actor_critic = Policy(
        ...
        envs.action_space,
        base_kwargs={'recurrent': args.recurrent_policy})  # !!!actor_critic corresponds g_policy in SLAM paper
        ...
        for step in range(args.num_steps):
            ...
            with torch.no_grad():
                value, action, action_log_prob, recurrent_hidden_states = actor_critic.act(
                    ...
                    rollouts.masks[step])
                    #rollouts.obs[step]: (1,4,84,84)
                    #rollouts.recurrent_hidden_states[step]:(1,1)???
                    # rollouts.masks[step] (1,1)???
                #pdb.set_trace()
