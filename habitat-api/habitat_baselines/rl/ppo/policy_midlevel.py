...
#changed
from config.config import REPRESENTATION_NAMES,RESIDUAL_LAYERS_PER_BLOCK,RESIDUAL_NEURON_CHANNEL,RESIDUAL_SIZE,STRIDES
...
class PointNavBaselineNet(Net):
    ...
    def __init__(self, observation_space, hidden_size):
        ...
        self.fc = FC() #changed TODO  to device
        self.upresnet = UpResNet(layers=RESIDUAL_LAYERS_PER_BLOCK, channels=RESIDUAL_NEURON_CHANNEL, sizes=RESIDUAL_SIZE,
                           strides=STRIDES)  #changed TODO  to device
