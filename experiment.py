...
def mid_level():
    ...
    depth_representation = visualpriors.representation_transform(o_t, 'depth_euclidean', device='cpu') # phi(o_t) in the diagram below
    normal_representation = visualpriors.representation_transform(o_t, 'normal', device='cpu') # phi(o_t) in the diagram below
